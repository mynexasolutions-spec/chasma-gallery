...
export const revenueChart = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const salesByCategory = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { rows } = await pool.query(`
